...
def p50(fname, workload, threads):
    for r in load(fname)["results"]:
        if r["workload"] == workload and r["threads"] == threads:
            return r["p50"]
    raise KeyError((fname, workload, threads))

rows = [
    ("WSL", "wsl_ticklog_fastwm_strip_r11.json", "fastwm STRIP r11"),
    ("WSL", "wsl_ticklog_fastwm_r11.json",       "fastwm r11"),
    ("WSL", "wsl_quill_cpp_r7.json",             "C++ quill r7"),
    ("WIN", "windows_ticklog_fastwm_strip_r11.json", "fastwm STRIP r11"),
    ("WIN", "windows_ticklog_fastwm_r11.json",       "fastwm r11"),
